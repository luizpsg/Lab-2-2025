...
class ProductService {
        ...
        if (existingProducts.length === 0) {
          const sampleProducts = [
            ...
            },
            {
              ...
              images: ["https://via.placeholder.com/300x300?text=Notebook+1"],
            ...
            },
            {
              ...
              images: ["https://via.placeholder.com/300x300?text=Fone+1"],
            ...
            },
            {
              ...
              images: ["https://via.placeholder.com/300x300?text=Camiseta+1"],
  ...
  async getProducts(req, res) {
    try {
      ...
      if (search) {
        products = await this.productsDb.search(search, [
          "name",
          "description",
          "tags",
        ]);
  ...
  async searchProducts(req, res) {
    try {
      ...
      let products = await this.productsDb.search(q, [
        "name",
        "description",
        "tags",
      ]);
