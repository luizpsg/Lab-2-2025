...
class APIGateway {
  ...
  setupRoutes() {
    ...
    this.app.use("/api/users", (req, res, next) => {
      console.log(
        `🔗 Roteando para user-service: ${req.method} ${req.originalUrl}`
      );
    ...
    this.app.use("/api/products", (req, res, next) => {
      console.log(
        `🔗 Roteando para product-service: ${req.method} ${req.originalUrl}`
      );
        ...
        products: {
          ...
          results:
            productResults.status === "fulfilled"
              ...
              : [],
          error:
            productResults.status === "rejected"
              ? productResults.reason.message
              : null,
        },
      };
        ...
        results.users = {
          ...
          results:
            userResults.status === "fulfilled"
              ...
              : [],
          error:
            userResults.status === "rejected"
              ? userResults.reason.message
              : null,
        };
      }
